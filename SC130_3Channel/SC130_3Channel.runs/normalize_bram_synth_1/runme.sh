...
HD_PWD='E:/WorkSpace/project/FPGA/SC130_3Channel/SC130_3Channel/SC130_3Channel.runs/normalize_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log normalize_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source normalize_bram.tcl
