...
HD_PWD='E:/WorkSpace/project/FPGA/SC130_3Channel/SC130_3Channel/SC130_3Channel.runs/maxtri7x7_shift_ram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maxtri7x7_shift_ram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maxtri7x7_shift_ram_0.tcl
