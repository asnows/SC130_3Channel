...
HD_PWD='E:/WorkSpace/project/FPGA/SC130_3Channel/SC130_3Channel/SC130_3Channel.runs/design_1_axi_vdma_imgCapture_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_vdma_imgCapture_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_vdma_imgCapture_0.tcl
